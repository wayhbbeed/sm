<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-03-20 16:35:08
         compiled from "D:\WWW\sm\app\templates\pages\sys_perm.tpl" */ ?>
<?php /*%%SmartyHeaderCode:32135550bdbbcc65d45-20970637%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f13ceef8f735f89f8ea2b26e5b3b6a4acfdfd48f' => 
    array (
      0 => 'D:\\WWW\\sm\\app\\templates\\pages\\sys_perm.tpl',
      1 => 1426666398,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '32135550bdbbcc65d45-20970637',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_550bdbbcdd40a7_37376630',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_550bdbbcdd40a7_37376630')) {function content_550bdbbcdd40a7_37376630($_smarty_tpl) {?><?php  $_config = new Smarty_Internal_Config("config_tpl.conf", $_smarty_tpl->smarty, $_smarty_tpl);$_config->loadConfigVars(null, 'local'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>联成迅康</title>
...
?>
			<tr>
				...
				<td><?php echo $_smarty_tpl->tpl_vars['a']->value['url'];?>
</td>
				<td><?php echo $_smarty_tpl->tpl_vars['a']->value['title'];?>
</td>
				<td><?php echo $_smarty_tpl->tpl_vars['a']->value['icon'];?>
</td>
				<td><?php echo $_smarty_tpl->tpl_vars['a']->value['pid'];?>
</td>
				<td><?php echo $_smarty_tpl->tpl_vars['a']->value['type'];?>
</td>
				<td><?php echo $_smarty_tpl->tpl_vars['a']->value['info'];?>
</td>
				...
				<?php if ($_smarty_tpl->tpl_vars['a']->value['live']==1) {?>
				<td>
					<a href="../control/control_users.php?uid=changlive&id=<?php echo $_smarty_tpl->tpl_vars['a']->value['id'];?>
&live=0" style="font-size:12px;">禁用</a>
				</td>
				<?php } else { ?>
				<td>
					<a href="../control/control_users.php?uid=changlive&id=<?php echo $_smarty_tpl->tpl_vars['a']->value['id'];?>
&live=1" style="font-size:12px;">启用</a>
				</td>
				<?php }?>
			</tr>
			<?php } ?>
